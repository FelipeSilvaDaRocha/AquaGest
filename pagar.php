        ...
        <section >
            <div>
                ...
                <table id="tabelaPagamentos">
                    ...
                    <?php
                        /*while($dados_pagamento = mysqli_fetch_assoc($resultadoPag)){
                            $periodo_apuracao = $dados_pagamento['periodo_apuracao'];
                            $situacao = $dados_pagamento['situacao'];
                            $data = $dados_pagamento['data_vencimento'];
                            echo '<tr>';
                            echo '<td>'.$periodo_apuracao.'</td>';
